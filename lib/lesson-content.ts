...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { instruction: "뒷발과 꼬리, 목걸이와 점무늬를 더해요.", choices: ["빨간 목걸이", "노란 목걸이"] }, { instruction: "내 마음대로 뼈다귀나 공을 더해요." },
    ],
  ...
  },
  {
    ...
    guide: [curve(1, [.34, .2], [.36, .1], [.64, .1], [.66, .2]), curve(1, [.66, .2], [.75, .34], [.66, .47], [.5, .47]), curve(1, [.5, .47], [.34, .47], [.25, .34], [.34, .2]), line(2, [.34, .2], [.35, .06], [.46, .16], [.34, .2]), line(2, [.54, .16], [.65, .06], [.66, .2], [.54, .16]), line(2, [.37, .16], [.39, .11], [.43, .17]), line(2, [.57, .17], [.61, .11], [.63, .16]), ellipse(3, .42, .29, .025, .035), ellipse(3, .58, .29, .025, .035), line(3, [.5, .33], [.47, .36], [.5, .38], [.53, .36], [.5, .33]), curve(3, [.5, .38], [.48, .43], [.44, .43], [.42, .4]), curve(3, [.5, .38], [.52, .43], [.56, .43], [.58, .4]), line(3, [.38, .36], [.22, .33]), line(3, [.38, .4], [.21, .43]), line(3, [.62, .36], [.78, .33]), line(3, [.62, .4], [.79, .43]), curve(4, [.39, .46], [.31, .56], [.32, .78], [.43, .84]), curve(4, [.43, .84], [.48, .88], [.52, .88], [.57, .84]), curve(4, [.57, .84], [.68, .78], [.69, .56], [.61, .46]), line(4, [.45, .62], [.44, .84], [.5, .84]), line(4, [.55, .62], [.56, .84], [.5, .84]), curve(5, [.63, .65], [.84, .48], [.93, .64], [.8, .74]), curve(5, [.8, .74], [.73, .8], [.68, .76], [.65, .71]), curve(5, [.41, .55], [.46, .59], [.54, .59], [.59, .55])],
  },
  {
